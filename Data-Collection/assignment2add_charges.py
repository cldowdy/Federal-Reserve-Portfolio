...
booking_addl-charge.clean. This is done by opening each file, and parsing through line by
line. First commas contained within double quotes are turned into periods. After, substrings
are right stripped. This gets the data into a noraml enough format to relativly painlessly
parse through it and write it to the file booking_add.clean

author: edelsonc & cdowdy
created: 09/04/2016
"""
